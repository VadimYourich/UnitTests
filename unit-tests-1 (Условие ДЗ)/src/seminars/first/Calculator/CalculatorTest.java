...
//        ).isInstanceOf(IllegalStateException.class);
        ...
        //    2. Проверка выброса исключения при отрицательной сумме покупке:
        assertThatThrownBy(() -> seminars.first.Calculator.Calculator.calculatingDiscount(-100.0, 10.0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Invalid arguments");
        //    3. Проверка выброса исключения при отрицательном проценте скидки:
        assertThatThrownBy(() -> seminars.first.Calculator.Calculator.calculatingDiscount(100.0, -10.0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Invalid arguments");
        //    4. Проверка выброса исключения при проценте скидки боле 100:
        assertThatThrownBy(() -> seminars.first.Calculator.Calculator.calculatingDiscount(100.0, 150.0))
                .isInstanceOf(ArithmeticException.class)
                .hasMessage("Invalid arguments");
    }
}